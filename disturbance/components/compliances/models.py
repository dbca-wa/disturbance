...
class Compliance(RevisionedMixin):
    ...
    proposal = models.ForeignKey('disturbance.Proposal',related_name='compliances', blank=True, null=True, on_delete=models.CASCADE)
    approval = models.ForeignKey('disturbance.Approval',related_name='compliances', on_delete=models.SET_NULL, null=True)
    ...
    assigned_to = models.ForeignKey(EmailUser,related_name='disturbance_compliance_assignments',null=True,blank=True, on_delete=models.SET_NULL)
    ...
    submitter = models.ForeignKey(EmailUser, blank=True, null=True, related_name='disturbance_compliances', on_delete=models.SET_NULL)
