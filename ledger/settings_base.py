...
ACCOUNT_OFFICERS_GROUP = env('ACCOUNT_OFFICERS_GROUP','Account Management Officers')
# Oscar settings
# from oscar.defaults import *
...
DJANGO_HTTPS = env('DJANGO_HTTPS',False)
if DJANGO_HTTPS is True:
    SECURE_PROXY_SSL_HEADER = ("HTTP_X_DJANGO_HTTPS","on")
